      ...
      headers: [
        {
          ...
          value:
            "default-src 'self'; script-src 'self' https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline'; img-src 'self' data:; font-src 'self'; connect-src 'self' https://api.github.com;", // Removed 'unsafe-inline' and 'unsafe-eval'
        },
        {
