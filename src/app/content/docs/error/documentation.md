---
title: Custom Error Page Documentation (src/app/error.tsx)
description: The Custom Error page (src/app/error.tsx) is displayed when an unexpected error occurs in the application. It provides a user-friendly message and options to try again or go back to the home page.
date: 2025-05-30
tags: ['error', 'page']
