---
title: IndexedDB Service Documentation (src/lib/indexeddb-service.ts)
description: The `src/lib/indexeddb-service.ts` file provides a service for interacting with IndexedDB using Dexie.js.
date: 2025-05-30
tags: ['indexeddb', 'data storage', 'service']
