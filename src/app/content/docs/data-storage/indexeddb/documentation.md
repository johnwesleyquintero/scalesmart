---
title: IndexedDB Documentation (src/lib/indexeddb.ts)
description: The `src/lib/indexeddb.ts` file defines a set of functions for interacting with IndexedDB to manage customer data.
date: 2025-05-30
tags: ['indexeddb', 'data storage']
