...
- **Supporting:** Amazon Seller Central (for standard CSV downloads), PostgreSQL/Supabase (for data storage/aggregation), React/Next.js (for custom dashboard UIs).
...
- **Solution:**
  ...
  - Refactored database queries for Supabase and added **strategic indexing** based on common lookup patterns.
