...
- **LocalStorage for Local Data:** localStorage (`src/lib/localstorage-service.ts`) is used for select modules to provide persistent local storage and reduce reliance on the backend.
