...
// Define custom components to be used within MDX for documentation pages
// These components will override default HTML elements with styling relevant to docs
export const mdxDocsComponents = {
  ...
  // Explicitly *exclude* Quiz and ExerciseModule from docs components
  // Quiz: Quiz,
  // ExerciseModule: ExerciseModule,
};

// This component is now just a placeholder for the components object
// The actual rendering will be done by MDXRemote
const MdxDocsComponents = () => {
  return null; // This component doesn't render anything directly
};

export default MdxDocsComponents;
