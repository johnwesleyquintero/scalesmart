    ...
    <section className="container mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Leveraging technology to build scalable systems and drive operational
          excellence
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <CardContent className="p-6 text-center relative z-10">
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} mb-4 group-hover:scale-110 transition-all duration-300 shadow-lg group-hover:shadow-xl`}
                >
