...
import { cn } from '@/lib/utils'; // Assuming this utility exists for tailwind-merge/clsx

// Define the props for SelectItem, ensuring 'label' is required
...
interface SelectProps<TValue extends string = string>
  ...
  value?: TValue; // Make value generic
  onValueChange?: (value: TValue) => void; // Make onValueChange generic
}
...
>(({ className, children, label, ...props }, ref) => {
  // Ensure children is always a ReactNode, and label is a string
  const itemContent = children || label;
  return (
