...
>(
  (
    ...
    // Filter out the 'ref' prop from the spread props
    const { ...restProps } = props; // Removed ref: _,
      ...
      <SidebarContextValue.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            ref={ref as any} // Explicitly assign the forwarded ref
            {...restProps} // Spread other props (without ref)
          >
            {children}
          </div>
        </TooltipProvider>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref as any} // Cast the forwarded ref to any
      data-sidebar="rail"
...
const GROUP_COLLAPSIBLE_ICON_HIDDEN = 'group-data-[collapsible=icon]:hidden';
  ...
  return (
    <div className={cn('flex flex-col gap-1', className)} {...props}>
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className={MENU_SKELETON_CLASS} />
      ))}
    </div>
  );
};
